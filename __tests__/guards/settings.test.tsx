 ...
 * settings-class surfaces (rule 2): each is drawn under the marker, so the
 * copy check proves no word of theirs is drawn outside it. Network setup is
 * drawn in the setup panel Welcome opens it in, which carries the marker.
 * The wallet picker sits in a shell phase instead, so it may show wallet
