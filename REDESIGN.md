...
| sending                 | The arrow launches and an orbit starts. The quote is spent: its ring fades out, and the sum dims to .4, so the screen reads as money going out rather than a review.                                                                                                                                 |
