...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `glyphs/Bloom`            | `size`, `mode?` `'still' \| 'breathe' \| 'chase' \| 'ratchet'`, `open?` (0 to 1), `tone?` `'live' \| 'test' \| 'dormant'`, `halo?`, `event?` `{ kind: 'burst' \| 'wilt' \| 'fold' \| 'fall' \| 'shake'; key }`, `detail?` `'full' \| 'mark'`, `accessibilityLabel?` | Decoration unless labelled, then one `image`. `detail` defaults to `mark` below 40pt. An `event` plays when its `key` changes.                                                                                                                                     |
